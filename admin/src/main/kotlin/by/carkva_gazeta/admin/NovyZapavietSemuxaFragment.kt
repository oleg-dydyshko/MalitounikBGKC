        ...
        activity?.let {
            if (MainActivity.isNetworkAvailable()) {
                bibleJob = CoroutineScope(Dispatchers.Main).launch {
                    ...
                    val zag = "Разьдзел"
                    BaseActivity.referens.child("/chytanne/Semucha/biblian$id.txt").getFile(localFile).addOnCompleteListener { task ->
                    ...
                    BaseActivity.referens.child("/chytanne/Semucha/biblian$id.txt").putFile(Uri.fromFile(localFile)).addOnCompleteListener { task ->
                        activity?.let {
                            if (task.isSuccessful) {
            ...
            urlJob = CoroutineScope(Dispatchers.Main).launch {
                activity?.let { fragmentActivity ->
                    ...
                    try {
                        ...
                        BaseActivity.referens.child(url).getFile(localFile).addOnCompleteListener { it ->
                            if (it.isSuccessful) {
