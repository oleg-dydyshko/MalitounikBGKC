...
class BibliaBokunaList : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ExpListAdapterNovyZapaviet(this, novyZapavet, groups)
        ...
        if (intent.extras?.getBoolean("prodolzyt", false) == true) {
            ...
            intent1.putExtra("perevod", DialogVybranoeBibleList.PEREVODBOKUNA)
    ...
    private class ExpListAdapterNovyZapaviet(private val mContext: Activity, private val novyZapavet: Boolean, private val groups: ArrayList<ArrayList<String>>) : BaseExpandableListAdapter() {
        ...
        override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
            ...
            rootView.textGroup.text = if (novyZapavet) mContext.resources.getStringArray(R.array.bokunan)[groupPosition]
            else mContext.resources.getStringArray(R.array.bokunas)[groupPosition]
