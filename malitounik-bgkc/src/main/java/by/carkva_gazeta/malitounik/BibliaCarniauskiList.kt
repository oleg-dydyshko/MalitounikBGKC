...
class BibliaCarniauskiList : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ExpListAdapter(this, novyZapavet, groups)
        ...
        if (intent.extras?.getBoolean("prodolzyt", false) == true) {
            ...
            intent1.putExtra("perevod", DialogVybranoeBibleList.PEREVODCARNIAUSKI)
    ...
    private class ExpListAdapter(private val mContext: Activity, private val novyZapavet: Boolean, private val groups: ArrayList<ArrayList<String>>) : BaseExpandableListAdapter() {
        ...
        override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
            ...
            rootView.textGroup.text = if (novyZapavet) mContext.resources.getStringArray(R.array.charniauskin)[groupPosition]
            else mContext.resources.getStringArray(R.array.charniauskis)[groupPosition]
