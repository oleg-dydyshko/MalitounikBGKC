...
class BibliaSemuxaList : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.extras?.getBoolean("prodolzyt", false) == true) {
            ...
            intent.putExtra("novyZapavet", novyZapavet)
            intent1.putExtra("perevod", DialogVybranoeBibleList.PEREVODSEMUXI)
    ...
    private class ExpListAdapterNovyZapaviet(private val mContext: Activity, private val novyZapavet: Boolean, private val groups: ArrayList<ArrayList<String>>) : BaseExpandableListAdapter() {
        ...
        override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
            ...
            rootView.textGroup.text = if (novyZapavet) mContext.resources.getStringArray(R.array.semuxan)[groupPosition]
            else mContext.resources.getStringArray(R.array.semuxas)[groupPosition]
