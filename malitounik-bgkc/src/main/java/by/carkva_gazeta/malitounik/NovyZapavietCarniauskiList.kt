...
class NovyZapavietCarniauskiList : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.elvMain.setOnChildClickListener { _: ExpandableListView?, _: View?, groupPosition: Int, childPosition: Int, _: Long ->
            ...
            if (checkmoduleResources()) {
                val intent = Intent()
                intent.setClassName(this, MainActivity.NOVYZAPAVIETCARNIAUSKI)
        ...
        if (intent.extras?.getBoolean("prodolzyt", false) == true) {
            val intent1 = Intent()
            intent1.setClassName(this, MainActivity.NOVYZAPAVIETCARNIAUSKI)
    ...
    private fun setTollbarTheme() {
        ...
        binding.subTitleToolbar.setText(R.string.novy_zapaviet)
        if (dzenNoch) {
    ...
    private class ExpListAdapterNovyZapaviet(private val mContext: Activity, private val groups: ArrayList<ArrayList<String>>) : BaseExpandableListAdapter() {
        ...
        override fun getGroupView(groupPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
            ...
            rootView.textGroup.text = mContext.resources.getStringArray(R.array.charniauskin)[groupPosition]
