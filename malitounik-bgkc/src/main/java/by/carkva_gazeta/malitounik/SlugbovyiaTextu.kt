...
class SlugbovyiaTextu {
    ...
    init {
        ...
        datMinALL.add(SlugbovyiaTextuData(38, "Уваскрасеньне Госпада Бога і Збаўцы нашага Ісуса Хрыста (Вялікдзень)", "vialikdzien_liturhija", LITURHIJA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        ...
        datMinALL.add(SlugbovyiaTextuData(42, "Нядзеля сьвятых айцоў I-га Усяленскага Сабору", "ndz_ajcou_1susviet_saboru_liturhija", LITURHIJA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
