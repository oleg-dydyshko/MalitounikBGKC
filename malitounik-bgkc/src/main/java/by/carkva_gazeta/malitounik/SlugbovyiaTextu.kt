...
abstract class SlugbovyiaTextu : BaseActivity() {
    ...
    init {
        ...
        datMinALL.add(SlugbovyiaTextuData(-27, "Панядзeлак 4-га тыдня вялікага посту", "tydzien_4_v_post_01paniadzielak_hadzina_6", HADZINA6, pasxa = true, mineia = MINEIA_VIALIKI_POST_4))
        ...
        datMinALL.add(SlugbovyiaTextuData(-26, "Аўторак 4-га тыдня вялікага посту", "tydzien_4_v_post_02autorak_hadzina_6", HADZINA6, pasxa = true, mineia = MINEIA_VIALIKI_POST_4))
        ...
        datMinALL.add(SlugbovyiaTextuData(-25, "Серада 4-га тыдня вялікага посту", "tydzien_4_v_post_03sierada_hadzina_6", HADZINA6, pasxa = true, mineia = MINEIA_VIALIKI_POST_4))
        ...
        datMinALL.add(SlugbovyiaTextuData(-24, "Чацьвер 4-га тыдня вялікага посту", "tydzien_4_v_post_04czacvier_hadzina_6", HADZINA6, pasxa = true, mineia = MINEIA_VIALIKI_POST_4))
        ...
        datMinALL.add(SlugbovyiaTextuData(-23, "Пятніца 4-га тыдня вялікага посту", "tydzien_4_v_post_05piatnica_hadzina_6", HADZINA6, pasxa = true, mineia = MINEIA_VIALIKI_POST_4))
        ...
        datMinALL.add(SlugbovyiaTextuData(97, "Сьвятога і роўнага апосталам Мятода, настаўніка славянскага і архібіскупа Мараўскага", "mm_06_04_miatoda_marauskaha_viaczernia", VIACZERNIA))
    ...
    fun loadSluzbaDayList(slugbaType: Int, dayOfYear: Int, year: Int): ArrayList<SlugbovyiaTextuData> {
        ...
        for (i in resultSlugba.indices) {
            val dayOfYearReal = getRealDay(resultSlugba[i].day, Calendar.getInstance()[Calendar.DAY_OF_YEAR], Calendar.getInstance()[Calendar.YEAR], resultSlugba[i].pasxa)
