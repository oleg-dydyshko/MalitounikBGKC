 ...
 */
class DialogSabytieContextMenu : DialogFragment() {
    ...
    companion object {
        fun getInstance(position: Int, title: String): DialogSabytieContextMenu {
            val dialogContextMenu = DialogSabytieContextMenu()
            val args = Bundle()
