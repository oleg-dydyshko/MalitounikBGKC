...
class MenuSviaty : BaseListFragment() {
    ...
    companion object {
        fun getPrazdnik(yearG: Int = Calendar.getInstance().get(Calendar.YEAR), search: Boolean = false): ArrayList<Prazdniki> {
            ...
            val monthName = BaseActivity.applicationContext().resources.getStringArray(R.array.meciac_smoll)
            val nedelName = BaseActivity.applicationContext().resources.getStringArray(R.array.dni_nedeli)
            val prazdnikiAll = ArrayList<Prazdniki>()
            val prazdnik = ArrayList<Prazdniki>()
            val c = GregorianCalendar(yearG, monthP - 1, dataP)
            prazdnikiAll.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], -1, BaseActivity.applicationContext().resources.getString(R.string.S1), c[Calendar.DATE].toString() + " " + monthName[c[Calendar.MONTH]] + " " + yearG + " году, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.JANUARY, 6)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], -2, BaseActivity.applicationContext().resources.getString(R.string.S2), "6 студзеня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, 1, 2)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S3), "2 лютага, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.MARCH, 25)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S4), "25 сакавіка, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(c[Calendar.YEAR], monthP - 1, dataP)
            c.add(Calendar.DATE, -7)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S5), c[Calendar.DAY_OF_MONTH].toString() + " " + monthName[c[Calendar.MONTH]] + ", " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.add(Calendar.DATE, 46)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S6), c[Calendar.DAY_OF_MONTH].toString() + " " + monthName[c[Calendar.MONTH]] + ", " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.add(Calendar.DATE, 10)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S7), c[Calendar.DAY_OF_MONTH].toString() + " " + monthName[c[Calendar.MONTH]] + ", " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.AUGUST, 6)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S8), "6 жніўня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.AUGUST, 15)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S9), "15 жніўня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.SEPTEMBER, 8)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S10), "8 верасьня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.SEPTEMBER, 14)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S11), "14 верасьня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.NOVEMBER, 21)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S12), "21 лістапада, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.DECEMBER, 25)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 2, BaseActivity.applicationContext().resources.getString(R.string.S13), "25 сьнежня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            prazdnik.sort()
            prazdnikiAll.addAll(prazdnik)
            prazdnik.clear()
            c.set(yearG, Calendar.JANUARY, 1)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], -3, BaseActivity.applicationContext().resources.getString(R.string.S14), "1 студзеня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.JUNE, 24)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 3, BaseActivity.applicationContext().resources.getString(R.string.S15), "24 чэрвеня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.JUNE, 29)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 3, BaseActivity.applicationContext().resources.getString(R.string.S16), "29 чэрвеня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.AUGUST, 29)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 3, BaseActivity.applicationContext().resources.getString(R.string.S17), "29 жніўня, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            c.set(yearG, Calendar.OCTOBER, 1)
            prazdnik.add(Prazdniki(c[Calendar.DAY_OF_YEAR], c[Calendar.DATE], c[Calendar.MONTH], 3, BaseActivity.applicationContext().resources.getString(R.string.S18), "1 кастрычніка, " + nedelName[c[Calendar.DAY_OF_WEEK]]))
            prazdnik.sort()
            prazdnikiAll.addAll(prazdnik)
            prazdnik.clear()
