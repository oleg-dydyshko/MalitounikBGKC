...
class MineiaShodzennaiaList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTollbarTheme()
        val dayOfYear = intent.extras?.getString("dayOfYear") ?: "1"
        val titleResource = intent.extras?.getString("titleResource") ?: "0"
        resourceUtran = intent.extras?.getString("resourceUtran") ?: "0"
        resourceLiturgia = intent.extras?.getString("resourceLiturgia") ?: "0"
        resourceViachernia = intent.extras?.getString("resourceViachernia") ?: "0"
