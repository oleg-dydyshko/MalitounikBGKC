...
class SlugbovyiaTextu {
    ...
    init {
        datMinALL.add(SlugbovyiaTextuData(6, "Нядзеля Тамаша (Антыпасха) вячэрня ў суботу", "ndz_tamasza_viaczernia_subota", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        ...
        datMinALL.add(SlugbovyiaTextuData(7, "Нядзеля Тамаша ўвечары", "ndz_tamasza_uvieczary", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        datMinALL.add(SlugbovyiaTextuData(8, "Панядзелак пасьля нядзелі Тамаша ўвечары", "ndz_tamasza_paniadzielak", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        datMinALL.add(SlugbovyiaTextuData(9, "Аўторак пасьля нядзелі Тамаша ўвечары", "ndz_tamasza_autorak", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        datMinALL.add(SlugbovyiaTextuData(10, "Серада пасьля нядзелі Тамаша ўвечары", "ndz_tamasza_sierada", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        datMinALL.add(SlugbovyiaTextuData(11, "Чацьвер пасьля нядзелі Тамаша ўвечары", "ndz_tamasza_czacvier", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        datMinALL.add(SlugbovyiaTextuData(12, "Пятніца пасьля нядзелі Тамаша ўвечары", "ndz_tamasza_piatnica", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        ...
        datMinALL.add(SlugbovyiaTextuData(20, "Нядзеля расслабленага вячэрня ў суботу", "ndz_rasslablenaha_viaczernia_u_subotu_vieczaram", VIACZERNIA, pasxa = true, mineia = MINEIA_SVIATOCHNAIA))
        ...
        datMinALL.add(SlugbovyiaTextuData(252, "Нараджэньне Найсьвяцейшае Багародзіцы", "mm_08_09_naradz_baharodzicy_liturhija", LITURHIJA))
        ...
        datMinALL.add(SlugbovyiaTextuData(256, "Адданьне сьвята Нараджэньня Багародзіцы", "mm_12_09_addannie_naradz_baharodzicy_viaczernia", VIACZERNIA))
