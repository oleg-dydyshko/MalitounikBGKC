...
class SlugbovyiaTextu {
    ...
    init {
        ...
        dat20.add(SlugbovyiaTextuData(50, "ТРОЙЦА (СЁМУХА)", "ju_trojca_mineia_sviatochnaia", utran = true, pasxa = true))
        dat20.add(SlugbovyiaTextuData(50, "ТРОЙЦА (СЁМУХА)", "l_trojca_mineia_sviatochnaia", liturgia = true, pasxa = true))
        dat20.add(SlugbovyiaTextuData(50, "ТРОЙЦА (СЁМУХА)", "v_trojca_mineia_sviatochnaia", pasxa = true))
        dat20.add(SlugbovyiaTextuData(40, "УЗЬНЯСЕНЬНЕ ГОСПАДА НАШАГА ІСУСА ХРЫСТА", "ju_uzniasenne_mineia_sviatochnaia", utran = true, pasxa = true))
        dat20.add(SlugbovyiaTextuData(40, "УЗЬНЯСЕНЬНЕ ГОСПАДА НАШАГА ІСУСА ХРЫСТА", "l_uzniasenne_mineia_sviatochnaia", liturgia = true, pasxa = true))
        dat20.add(SlugbovyiaTextuData(40, "УЗЬНЯСЕНЬНЕ ГОСПАДА НАШАГА ІСУСА ХРЫСТА", "v_uzniasenne_mineia_sviatochnaia", pasxa = true))
