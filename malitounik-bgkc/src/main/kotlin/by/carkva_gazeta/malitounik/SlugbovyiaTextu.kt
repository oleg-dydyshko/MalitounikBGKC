...
class SlugbovyiaTextu {
    ...
    init {
        ...
        datMinSH.add(SlugbovyiaTextuData(82, "Сьвятога вялікамучаніка Юрыя", "mm_23_04_juryja_pieramozcy_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(82, "Сьвятога вялікамучаніка Юрыя", "mm_23_04_juryja_pieramozcy_viaczernia", VIACZERNIA))
