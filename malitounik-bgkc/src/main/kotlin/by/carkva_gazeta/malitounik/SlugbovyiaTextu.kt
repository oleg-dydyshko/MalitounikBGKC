...
class SlugbovyiaTextu {
    ...
    init {
        ...
        datMinVP.add(SlugbovyiaTextuData(-6, "Ютрань Вялікага панядзелака", "vialiki_paniadzielak", JUTRAN, pasxa = true))
        datMinVP.add(SlugbovyiaTextuData(-5, "Ютрань Вялікага аўторака", "vialiki_autorak", JUTRAN, pasxa = true))
        datMinVP.add(SlugbovyiaTextuData(-4, "Ютрань Вялікай серады", "vialikaja_sierada", JUTRAN, pasxa = true))
        datMinVP.add(SlugbovyiaTextuData(-3, "Ютрань Вялікага чацьверга", "vialiki_czacvier", JUTRAN, pasxa = true))
        datMinVP.add(SlugbovyiaTextuData(-2, "Ютрань Вялікай пятніцы", "jutran_vial_piatn_12jevanhellau", JUTRAN, pasxa = true))
        ...
        datMinVP.add(SlugbovyiaTextuData(-1, "Ютрань Вялікай суботы", "vialikaja_subota_jutran", JUTRAN, pasxa = true))
        ...
        datMinVP.add(SlugbovyiaTextuData(0, "Уваскрасеньне Госпада Бога і Збаўцы нашага Ісуса Хрыста (Вялікдзень)", "viaczernia_vialikdzien", VIACZERNIA, pasxa = true))
        ...
        datMinSH.add(SlugbovyiaTextuData(312, "Сабор сьвятога арханёла Міхаіла і ўсіх анёльскіх сілаў", "mm_08_11_jutran", JUTRAN))
        datMinSH.add(SlugbovyiaTextuData(312, "Сабор сьвятога арханёла Міхаіла і ўсіх анёльскіх сілаў", "mm_08_11_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(312, "Сабор сьвятога арханёла Міхаіла і ўсіх анёльскіх сілаў", "mm_08_11_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(317, "Між сьвятымі айца нашага Яна Залатавуснага", "mm_13_11_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(317, "Між сьвятымі айца нашага Яна Залатавуснага", "mm_13_11_liturhija", LITURHIJA))
        ...
        datMinSH.add(SlugbovyiaTextuData(127, "Жырoвiцкaй iкoны Maцi Бoжae", "mm_07_05_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(131, "Сьвятых і роўных апосталам настаўнікаў славянскіх Кірылы і Мятода", "mm_11_05_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(141, "Сьвятых роўнаапостальных Канстанціна і Алены", "mm_21_05_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(141, "Сьвятых роўнаапостальных Канстанціна і Алены", "mm_21_05_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(143, "Сьвятое маці нашае Еўфрасіньні Полацкай", "mm_23_05_jutran", JUTRAN))
        datMinSH.add(SlugbovyiaTextuData(143, "Сьвятое маці нашае Еўфрасіньні Полацкай", "mm_23_05_liturhija", LITURHIJA))
        ...
        datMinSH.add(SlugbovyiaTextuData(251, "Нараджэньне Найсьвяцейшае Багародзіцы", "mm_08_09_naradz_baharodzicy_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(252, "Пасьвяцьце Нараджэньня Багародзіцы і сьвятых Якіма і Ганны", "mm_09_09_pasviaccie_naradz_baharodz_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(253, "Пасьвяцьце Нараджэньня Багародзіцы і сьвятых мучаніц Мінадоры, Мітрадоры і Німфадоры", "mm_10_09_pasviaccie_naradz_baharodz_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(254, "Пасьвяцьце Нараджэньня Багародзіцы і сьвятое маці нашае Тадоры", "mm_11_09_pasviaccie_naradz_baharodz_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(255, "Адданьне сьвята Нараджэньня Багародзіцы", "mm_12_09_addannie_naradz_baharodzicy_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(256, "Перадсьвяцьце Ўзвышэньня, памяць аднаўленьня царквы Ўваскрасеньня і сьвятога мучаніка Карніла", "mm_13_09_pieradsv_uzvyszennia_liturhija", LITURHIJA))
        ...
        datMinSH.add(SlugbovyiaTextuData(221, "Пасьвяцьце Перамяненьня і сьв. апостала Мацея", "mm_09_08_pasviaccie_pieramianiennia_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(221, "Пасьвяцьце Перамяненьня і сьв. апостала Мацея", "mm_09_08_pasviaccie_pieramianennia_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(227, "Усьпеньне Найсьвяцейшай Багародзіцы і Заўсёды Дзевы Марыі", "mm_15_08_uspiennie_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(227, "Усьпеньне Найсьвяцейшай Багародзіцы і Заўсёды Дзевы Марыі", "mm_15_08_uspiennie_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(222, "Пасьвяцьце Перамяненьня і сьв. мучаніка Лаўрына", "mm_10_08_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(226, "Перадсьвяцьце Ўсьпеньня і сьв. прарока Міхея", "mm_14_08_pieradsv_uspiennia_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(226, "Перадсьвяцьце Ўсьпеньня і сьв. прарока Міхея", "mm_14_08_pieradsv_uspiennia_liturhija", LITURHIJA))
        ...
        datMinSH.add(SlugbovyiaTextuData(340, "Між сьвятымі айца нашага Міколы Цудатворца, архібіскупа Мірлікійскага", "mm_06_12_mikoly_cudatvorcy_jutran", JUTRAN))
        datMinSH.add(SlugbovyiaTextuData(340, "Між сьвятымі айца нашага Міколы Цудатворца, архібіскупа Мірлікійскага", "mm_06_12_mikoly_cudatvorcy_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(340, "Між сьвятымі айца нашага Міколы Цудатворца, архібіскупа Мірлікійскага", "mm_06_12_mikoly_cudatvorcy_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(316, "Сьвятога сьвятамучаніка Язафата, архібіскупа Полацкага", "mm_12_11_sviatamucz_jazafat_jutran", JUTRAN))
        datMinSH.add(SlugbovyiaTextuData(316, "Сьвятога сьвятамучаніка Язафата, архібіскупа Полацкага", "mm_12_11_sviatamucz_jazafat_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(316, "Сьвятога сьвятамучаніка Язафата, архібіскупа Полацкага", "mm_12_11_sviatamucz_jazafat_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(354, "Перадсьвяцьце Нараджэньня Госпада нашага Ісуса Хрыста і сьв. сьвятамучаніка Ігната Баганосца", "mm_20_12_rastvo_peradsviaccie_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(354, "Перадсьвяцьце Нараджэньня Госпада нашага Ісуса Хрыста і сьв. сьвятамучаніка Ігната Баганосца", "mm_20_12_rastvo_peradsviaccie_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(358, "Чаканьне (Сьвяты вечар) Нараджэньня Госпада нашага Ісуса Хрыста і сьв. мучаніцы Яўгеніі", "mm_24_12_rastvo_sv_vieczar_abednica", ABIEDNICA))
        datMinSH.add(SlugbovyiaTextuData(358, "Чаканьне (Сьвяты вечар) Нараджэньня Госпада нашага Ісуса Хрыста і сьв. мучаніцы Яўгеніі", "mm_24_12_rastvo_sv_vieczar_jutran", JUTRAN))
        datMinSH.add(SlugbovyiaTextuData(358, "Чаканьне (Сьвяты вечар) Нараджэньня Госпада нашага Ісуса Хрыста і сьв. мучаніцы Яўгеніі", "mm_24_12_rastvo_sv_vieczar_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(358, "Чаканьне (Сьвяты вечар) Нараджэньня Госпада нашага Ісуса Хрыста і сьв. мучаніцы Яўгеніі", "mm_24_12_rastvo_sv_vieczar_vial_hadziny", VIALHADZINY))
        datMinSH.add(SlugbovyiaTextuData(359, "Нараджэньне Госпада, Бога і Збаўцы нашага Ісуса Хрыста", "mm_25_12_naradzennie_chrystova_liturhija", LITURHIJA))
        ...
        datMinSH.add(SlugbovyiaTextuData(65, "Сьвятога і роўнага апосталам Мятода, настаўніка славянскага і архібіскупа Мараўскага", "mm_06_04_miatoda_marauskaha_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(73, "Пачэснага айца нашага Бенядыкта", "mm_14_03_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(76, "Аляксея, чалавека Божага", "mm_17_03_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(77, "Між сьвятымі айца нашага Кірылы, біскупа Ерусалімскага", "mm_18_03_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(113, "Сьвятога вялікамучаніка Юрыя", "mm_23_04_juryja_pieramozcy_liturhija", LITURHIJA))
        datMinSH.add(SlugbovyiaTextuData(113, "Сьвятога вялікамучаніка Юрыя", "mm_23_04_juryja_pieramozcy_viaczernia", VIACZERNIA))
        datMinSH.add(SlugbovyiaTextuData(83, "Перадсьвяцьце Дабравешчаньня", "mm_24_03_pieradsv_dabravieszczannia_liturhija", LITURHIJA))
