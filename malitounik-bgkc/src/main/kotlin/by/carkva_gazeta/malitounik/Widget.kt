...
class Widget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val widgetID = intent.extras?.getInt("widgetID") ?: AppWidgetManager.INVALID_APPWIDGET_ID
    ...
    companion object {
        ...
        fun kaliandar(context: Context, appWidgetManager: AppWidgetManager, widgetID: Int) {
            ...
            settings.putExtra("widgetID", widgetID)
            val pSsettings = PendingIntent.getBroadcast(context, 40 + widgetID, settings, flags)
