...
class MalitvyPrynagodnyia : BaseActivity(), DialogClearHishory.DialogClearHistoryListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rub3.add(MenuListData("Малітва на асьвячэньне памятнай табліцы ўсім бязьвінным ахвярам, якія пацярпелі за Беларусь", "mltv_asviacz_pamiatnaj_tablicy_biazvinnym_achviaram_paciarpieli_za_bielarus"))
        rub3.add(MenuListData("Малітва на асьвячэньне памятнай табліцы ўсім бязьвінным ахвярам, якія пацярпелі за Беларусь 2", "mltv_asviacz_pamiatnaj_tablicy_paciarpieu_za_bielarus1"))
        rub3.sort()
        ...
        rub6.add(MenuListData("Малітва на асьвячэньне памятнай табліцы Слузе Божаму", "mltv_asviacz_pamiatnaj_tablicy"))
        rub6.add(MenuListData("Блаславеньне ўсялякае рэчы", "mltv_blaslaviennie_usialakaj_reczy"))
        rub6.sort()
        data.add(rub1)
        data.add(rub2)
        data.add(rub3)
