...
class NovyZapavietBokunaFragment : BaseFragment(), OnItemLongClickListener, AdapterView.OnItemClickListener {
    private var kniga = 0
    private var page = 0
    ...
    companion object {
        fun newInstance(title: String, page: Int, kniga: Int, pazicia: Int): NovyZapavietBokunaFragment {
            val fragmentFirst = NovyZapavietBokunaFragment()
            val args = Bundle()
