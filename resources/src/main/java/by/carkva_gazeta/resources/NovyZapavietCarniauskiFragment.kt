...
class NovyZapavietCarniauskiFragment : BaseFragment(), OnItemLongClickListener, AdapterView.OnItemClickListener {
    private var kniga = 0
    private var page = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (kniga) {
            ...
            5 -> inputStream = resources.openRawResource(R.raw.carniauskin6)
            6 -> inputStream = resources.openRawResource(R.raw.carniauskin7)
            7 -> inputStream = resources.openRawResource(R.raw.carniauskin8)
            8 -> inputStream = resources.openRawResource(R.raw.carniauskin9)
            9 -> inputStream = resources.openRawResource(R.raw.carniauskin10)
            10 -> inputStream = resources.openRawResource(R.raw.carniauskin11)
            11 -> inputStream = resources.openRawResource(R.raw.carniauskin12)
            12 -> inputStream = resources.openRawResource(R.raw.carniauskin13)
            13 -> inputStream = resources.openRawResource(R.raw.carniauskin14)
            14 -> inputStream = resources.openRawResource(R.raw.carniauskin15)
            15 -> inputStream = resources.openRawResource(R.raw.carniauskin16)
            16 -> inputStream = resources.openRawResource(R.raw.carniauskin17)
            17 -> inputStream = resources.openRawResource(R.raw.carniauskin18)
            18 -> inputStream = resources.openRawResource(R.raw.carniauskin19)
            19 -> inputStream = resources.openRawResource(R.raw.carniauskin20)
            20 -> inputStream = resources.openRawResource(R.raw.carniauskin21)
            21 -> inputStream = resources.openRawResource(R.raw.carniauskin22)
            22 -> inputStream = resources.openRawResource(R.raw.carniauskin23)
            23 -> inputStream = resources.openRawResource(R.raw.carniauskin24)
            24 -> inputStream = resources.openRawResource(R.raw.carniauskin25)
            25 -> inputStream = resources.openRawResource(R.raw.carniauskin26)
        ...
        activity?.let { activity ->
            adapter = BibleArrayAdapterParallel(activity, bible, kniga, page, true, DialogVybranoeBibleList.PEREVODCARNIAUSKI)
            ...
            binding.zametka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    ...
                    val natatka = DialogBibleNatatka.getInstance(perevod = DialogVybranoeBibleList.PEREVODCARNIAUSKI, novyzavet = true, kniga = kniga, glava = BibleGlobalList.mListGlava, stix = BibleGlobalList.bibleCopyList[0], bibletext = knigaName)
    ...
    companion object {
        fun newInstance(title: String, page: Int, kniga: Int, pazicia: Int): NovyZapavietCarniauskiFragment {
            val fragmentFirst = NovyZapavietCarniauskiFragment()
            val args = Bundle()
