...
import kotlinx.android.synthetic.main.nadsan_pravila1.*

class PsalterNadsana1 internal constructor(private val activity: Activity) : Fragment(), View.OnClickListener {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.nadsan_pravila1, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (dzenNoch) {
            ...
            t2.setBackgroundResource(by.carkva_gazeta.malitounik.R.drawable.nadsanblack)
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id ?: 0) {
            ...
            R.id.textView8, R.id.textView24, R.id.textView22, R.id.textView20, R.id.textView16, R.id.textView12 -> glava = 18
            R.id.textView9, R.id.textView11 -> glava = 7
            R.id.textView10 -> glava = 9
            R.id.textView13, R.id.textView15 -> glava = 10
            R.id.textView14 -> glava = 12
            R.id.textView17, R.id.textView19 -> glava = 13
            R.id.textView18 -> glava = 15
            R.id.textView21, R.id.textView23 -> glava = 19
            R.id.textView25, R.id.textView27 -> glava = 16
