...
import by.carkva_gazeta.resources.databinding.NadsanPravila2Binding

class PsalterNadsana2 : BaseFragment(), View.OnClickListener {

    private var _binding: NadsanPravila2Binding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = NadsanPravila2Binding.inflate(inflater, container, false)
        return binding.root
    }
