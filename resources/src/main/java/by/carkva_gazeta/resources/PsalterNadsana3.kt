...
import by.carkva_gazeta.resources.databinding.NadsanPravila3Binding

class PsalterNadsana3 : BaseFragment(), View.OnClickListener {

    private var _binding: NadsanPravila3Binding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = NadsanPravila3Binding.inflate(inflater, container, false)
        return binding.root
    }
