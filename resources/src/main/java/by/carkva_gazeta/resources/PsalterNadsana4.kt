...
import kotlinx.android.synthetic.main.nadsan_pravila4.*

class PsalterNadsana4 internal constructor(private val activity: Activity) : Fragment(), View.OnClickListener {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.nadsan_pravila4, container, false)
    }
