...
class StaryZapavietBokuna : BaseActivity(), DialogFontSizeListener, DialogBibleRazdelListener, BibleListiner, DialogBibleNatatka.DialogBibleNatatkaListiner, DialogAddZakladka.DialogAddZakladkiListiner, DialogHelpFullScreenSettings.DialogHelpFullScreenSettingsListener {
    ...
    override fun onPause() {
        ...
        prefEditors.putBoolean("bible_time_bokuna_zavet", false)
        ...
        val listFiles = File("$filesDir/BibliaBokunaStaryZavet").listFiles()
        listFiles?.forEach {
        ...
        val file = File("$filesDir/BibliaBokunaStaryZavet/$kniga.json")
    ...
    override fun addZakladka(color: Int) {
        val fragment = supportFragmentManager.findFragmentByTag("f" + binding.pager.currentItem) as StaryZapavietBokunaFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = resources.getStringArray(R.array.bokunas)[kniga]
    ...
    private fun setTollbarTheme() {
        ...
        binding.subtitleToolbar.text = getString(R.string.title_biblia_bokun2)
        if (dzenNoch) {
    ...
    override fun onMenuItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.action_vybranoe) {
            men = DialogVybranoeBibleList.setVybranoe(title, kniga, BibleGlobalList.mListGlava, DialogVybranoeBibleList.PEREVODBOKUNA)
            if (men) {
    ...
    private inner class MyPagerAdapter(activity: FragmentActivity) : FragmentStateAdapter(activity) {
        ...
        override fun onBindViewHolder(holder: FragmentViewHolder, position: Int, payloads: MutableList<Any>) {
            ...
            val fragment = supportFragmentManager.findFragmentByTag("f" + holder.itemId) as? StaryZapavietBokunaFragment
            fragment?.upDateListView()
        }

        override fun getItemCount() = fullglav

        override fun createFragment(position: Int): StaryZapavietBokunaFragment {
            val styx = if (glava != position) 0
            else fierstPosition
            return StaryZapavietBokunaFragment.newInstance(title, position, kniga, styx)
        }
    }
}