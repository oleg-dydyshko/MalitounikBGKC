...
class StaryZapavietBokunaFragment : BaseFragment(), OnItemLongClickListener, AdapterView.OnItemClickListener {
    private var kniga = 0
    private var page = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var inputStream = resources.openRawResource(R.raw.bokunas1)
        when (kniga) {
            0 -> {
                knigaReal = 0
                inputStream = resources.openRawResource(R.raw.bokunas1)
            }
            1 -> {
                knigaReal = 1
                inputStream = resources.openRawResource(R.raw.bokunas2)
            }
            2 -> {
                knigaReal = 2
                inputStream = resources.openRawResource(R.raw.bokunas3)
            }
            3 -> {
                knigaReal = 3
                inputStream = resources.openRawResource(R.raw.bokunas4)
            }
            4 -> {
                knigaReal = 4
                inputStream = resources.openRawResource(R.raw.bokunas5)
            }
            5 -> {
                knigaReal = 5
                inputStream = resources.openRawResource(R.raw.bokunas6)
            }
            6 -> {
                knigaReal = 6
                inputStream = resources.openRawResource(R.raw.bokunas7)
            }
            7 -> {
                knigaReal = 7
                inputStream = resources.openRawResource(R.raw.bokunas8)
            }
            8 -> {
                knigaReal = 8
                inputStream = resources.openRawResource(R.raw.bokunas9)
            }
            9 -> {
                knigaReal = 9
                inputStream = resources.openRawResource(R.raw.bokunas10)
            }
            10 -> {
                knigaReal = 10
                inputStream = resources.openRawResource(R.raw.bokunas11)
            }
            11 -> {
                knigaReal = 11
                inputStream = resources.openRawResource(R.raw.bokunas12)
            }
            12 -> {
                knigaReal = 12
                inputStream = resources.openRawResource(R.raw.bokunas13)
            }
            13 -> {
                knigaReal = 13
                inputStream = resources.openRawResource(R.raw.bokunas14)
            }
            14 -> {
                knigaReal = 14
                inputStream = resources.openRawResource(R.raw.bokunas15)
            }
            15 -> {
                knigaReal = 15
                inputStream = resources.openRawResource(R.raw.bokunas16)
            }
            16 -> {
                knigaReal = 19
                inputStream = resources.openRawResource(R.raw.bokunas17)
            }
            17 -> {
                knigaReal = 20
                inputStream = resources.openRawResource(R.raw.bokunas18)
            }
            18 -> {
                knigaReal = 21
                inputStream = resources.openRawResource(R.raw.bokunas19)
            }
            19 -> {
                knigaReal = 22
                inputStream = resources.openRawResource(R.raw.bokunas20)
            }
            20 -> {
                knigaReal = 23
                inputStream = resources.openRawResource(R.raw.bokunas21)
            }
            21 -> {
                knigaReal = 24
                inputStream = resources.openRawResource(R.raw.bokunas22)
            }
            22 -> {
                knigaReal = 27
                inputStream = resources.openRawResource(R.raw.bokunas23)
            }
            23 -> {
                knigaReal = 28
                inputStream = resources.openRawResource(R.raw.bokunas24)
            }
            24 -> {
                knigaReal = 29
                inputStream = resources.openRawResource(R.raw.bokunas25)
            }
            25 -> {
                knigaReal = 32
                inputStream = resources.openRawResource(R.raw.bokunas26)
            }
            26 -> {
                knigaReal = 33
                inputStream = resources.openRawResource(R.raw.bokunas27)
            }
            27 -> {
                knigaReal = 34
                inputStream = resources.openRawResource(R.raw.bokunas28)
            }
            28 -> {
                knigaReal = 35
                inputStream = resources.openRawResource(R.raw.bokunas29)
            }
            29 -> {
                knigaReal = 36
                inputStream = resources.openRawResource(R.raw.bokunas30)
            }
            30 -> {
                knigaReal = 37
                inputStream = resources.openRawResource(R.raw.bokunas31)
            }
            31 -> {
                knigaReal = 38
                inputStream = resources.openRawResource(R.raw.bokunas32)
            }
            32 -> {
                knigaReal = 39
                inputStream = resources.openRawResource(R.raw.bokunas33)
            }
            33 -> {
                knigaReal = 40
                inputStream = resources.openRawResource(R.raw.bokunas34)
            }
            34 -> {
                knigaReal = 41
                inputStream = resources.openRawResource(R.raw.bokunas35)
            }
            35 -> {
                knigaReal = 42
                inputStream = resources.openRawResource(R.raw.bokunas36)
            }
            36 -> {
                knigaReal = 43
                inputStream = resources.openRawResource(R.raw.bokunas37)
            }
            37 -> {
                knigaReal = 44
                inputStream = resources.openRawResource(R.raw.bokunas38)
            }
            38 -> {
                knigaReal = 45
                inputStream = resources.openRawResource(R.raw.bokunas39)
            }
        }
        ...
        activity?.let { activity ->
            adapter = BibleArrayAdapterParallel(activity, bible, knigaReal, page, false, DialogVybranoeBibleList.PEREVODBOKUNA)
            ...
            binding.zakladka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    ...
                    for (i in BibleGlobalList.zakladkiBokuna.indices) {
                        if (BibleGlobalList.zakladkiBokuna[i].data.contains(MainActivity.fromHtml(bible[BibleGlobalList.bibleCopyList[0]]).toString())) {
                            index = i
                            break
                        }
                    }
                    if (index == -1) {
                        ...
                        BibleGlobalList.zakladkiBokuna.removeAt(index)
                        BibleGlobalList.mPedakVisable = false
                        BibleGlobalList.bibleCopyList.clear()
                    }
                    binding.linearLayout4.animation = AnimationUtils.loadAnimation(activity.baseContext, by.carkva_gazeta.malitounik.R.anim.slide_in_buttom)
            ...
            binding.zametka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    ...
                    val zametka = DialogBibleNatatka.getInstance(perevod = DialogVybranoeBibleList.PEREVODBOKUNA, novyzavet = false, kniga = knigaReal, glava = BibleGlobalList.mListGlava, stix = BibleGlobalList.bibleCopyList[0], bibletext = knigaName)
    ...
    companion object {
        fun newInstance(title: String, page: Int, kniga: Int, pazicia: Int): StaryZapavietBokunaFragment {
            val fragmentFirst = StaryZapavietBokunaFragment()
            val args = Bundle()
