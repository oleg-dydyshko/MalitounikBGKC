...
class StaryZapavietCarniauskiFragment : BaseFragment(), OnItemLongClickListener, AdapterView.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let { activity ->
            adapter = BibleArrayAdapterParallel(activity, bible, knigaReal, page, false, 5)
            ...
            binding.zametka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    ...
                    val zametka = DialogBibleNatatka.getInstance(semuxa = true, novyzavet = false, kniga = knigaReal, glava = BibleGlobalList.mListGlava, stix = BibleGlobalList.bibleCopyList[0], bibletext = knigaName)
