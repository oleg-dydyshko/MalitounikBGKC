...
class StaryZapavietCarniauskiFragment : BaseFragment(), OnItemLongClickListener, AdapterView.OnItemClickListener {
    private var kniga = 0
    private var page = 0
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var inputStream = resources.openRawResource(R.raw.carniauskis1)
        when (kniga) {
            0 -> {
                knigaReal = 0
                inputStream = resources.openRawResource(R.raw.carniauskis1)
            }
            1 -> {
                knigaReal = 1
                inputStream = resources.openRawResource(R.raw.carniauskis2)
            }
            2 -> {
                knigaReal = 2
                inputStream = resources.openRawResource(R.raw.carniauskis3)
            }
            3 -> {
                knigaReal = 3
                inputStream = resources.openRawResource(R.raw.carniauskis4)
            }
            4 -> {
                knigaReal = 4
                inputStream = resources.openRawResource(R.raw.carniauskis5)
            }
            5 -> {
                knigaReal = 5
                inputStream = resources.openRawResource(R.raw.carniauskis6)
            }
            6 -> {
                knigaReal = 6
                inputStream = resources.openRawResource(R.raw.carniauskis7)
            }
            7 -> {
                knigaReal = 7
                inputStream = resources.openRawResource(R.raw.carniauskis8)
            }
            8 -> {
                knigaReal = 8
                inputStream = resources.openRawResource(R.raw.carniauskis9)
            }
            9 -> {
                knigaReal = 9
                inputStream = resources.openRawResource(R.raw.carniauskis10)
            }
            10 -> {
                knigaReal = 10
                inputStream = resources.openRawResource(R.raw.carniauskis11)
            }
            11 -> {
                knigaReal = 11
                inputStream = resources.openRawResource(R.raw.carniauskis12)
            }
            12 -> {
                knigaReal = 12
                inputStream = resources.openRawResource(R.raw.carniauskis13)
            }
            13 -> {
                knigaReal = 13
                inputStream = resources.openRawResource(R.raw.carniauskis14)
            }
            14 -> {
                knigaReal = 14
                inputStream = resources.openRawResource(R.raw.carniauskis15)
            }
            15 -> {
                knigaReal = 15
                inputStream = resources.openRawResource(R.raw.carniauskis16)
            }
            16 -> {
                knigaReal = 19
                inputStream = resources.openRawResource(R.raw.carniauskis17)
            }
            17 -> {
                knigaReal = 20
                inputStream = resources.openRawResource(R.raw.carniauskis18)
            }
            18 -> {
                knigaReal = 21
                inputStream = resources.openRawResource(R.raw.carniauskis19)
            }
            19 -> {
                knigaReal = 22
                inputStream = resources.openRawResource(R.raw.carniauskis20)
            }
            20 -> {
                knigaReal = 23
                inputStream = resources.openRawResource(R.raw.carniauskis21)
            }
            21 -> {
                knigaReal = 24
                inputStream = resources.openRawResource(R.raw.carniauskis22)
            }
            22 -> {
                knigaReal = 27
                inputStream = resources.openRawResource(R.raw.carniauskis23)
            }
            23 -> {
                knigaReal = 28
                inputStream = resources.openRawResource(R.raw.carniauskis24)
            }
            24 -> {
                knigaReal = 29
                inputStream = resources.openRawResource(R.raw.carniauskis25)
            }
            25 -> {
                knigaReal = 32
                inputStream = resources.openRawResource(R.raw.carniauskis26)
            }
            26 -> {
                knigaReal = 33
                inputStream = resources.openRawResource(R.raw.carniauskis27)
            }
            27 -> {
                knigaReal = 34
                inputStream = resources.openRawResource(R.raw.carniauskis28)
            }
            28 -> {
                knigaReal = 35
                inputStream = resources.openRawResource(R.raw.carniauskis29)
            }
            29 -> {
                knigaReal = 36
                inputStream = resources.openRawResource(R.raw.carniauskis30)
            }
            30 -> {
                knigaReal = 37
                inputStream = resources.openRawResource(R.raw.carniauskis31)
            }
            31 -> {
                knigaReal = 38
                inputStream = resources.openRawResource(R.raw.carniauskis32)
            }
            32 -> {
                knigaReal = 39
                inputStream = resources.openRawResource(R.raw.carniauskis33)
            }
            33 -> {
                knigaReal = 40
                inputStream = resources.openRawResource(R.raw.carniauskis34)
            }
            34 -> {
                knigaReal = 41
                inputStream = resources.openRawResource(R.raw.carniauskis35)
            }
            35 -> {
                knigaReal = 42
                inputStream = resources.openRawResource(R.raw.carniauskis36)
            }
            36 -> {
                knigaReal = 43
                inputStream = resources.openRawResource(R.raw.carniauskis37)
            }
            37 -> {
                knigaReal = 44
                inputStream = resources.openRawResource(R.raw.carniauskis38)
            }
            38 -> {
                knigaReal = 45
                inputStream = resources.openRawResource(R.raw.carniauskis39)
            }
            39 -> {
                knigaReal = 17
                inputStream = resources.openRawResource(R.raw.carniauskis40)
            }
            40 -> {
                knigaReal = 18
                inputStream = resources.openRawResource(R.raw.carniauskis41)
            }
            41 -> {
                knigaReal = 25
            ...
            42 -> {
                knigaReal = 26
                inputStream = resources.openRawResource(R.raw.carniauskis43)
            }
            43 -> {
                knigaReal = 31
                inputStream = resources.openRawResource(R.raw.carniauskis44)
            }
            44 -> {
                knigaReal = 46
                inputStream = resources.openRawResource(R.raw.carniauskis45)
            }
            45 -> {
                knigaReal = 47
                inputStream = resources.openRawResource(R.raw.carniauskis46)
            }
        }
        ...
        activity?.let { activity ->
            adapter = BibleArrayAdapterParallel(activity, bible, knigaReal, page, false, DialogVybranoeBibleList.PEREVODCARNIAUSKI)
            ...
            binding.zakladka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    var index = -1
                    for (i in BibleGlobalList.zakladkiCarniauski.indices) {
                        if (BibleGlobalList.zakladkiCarniauski[i].data.contains(MainActivity.fromHtml(bible[BibleGlobalList.bibleCopyList[0]]).toString())) {
                            index = i
                            break
                        }
                    }
                    if (index == -1) {
                        ...
                        BibleGlobalList.zakladkiCarniauski.removeAt(index)
                        BibleGlobalList.mPedakVisable = false
                        BibleGlobalList.bibleCopyList.clear()
                    }
                    binding.linearLayout4.animation = AnimationUtils.loadAnimation(activity.baseContext, by.carkva_gazeta.malitounik.R.anim.slide_in_buttom)
            ...
            binding.zametka.setOnClickListener {
                if (BibleGlobalList.bibleCopyList.size > 0) {
                    ...
                    val zametka = DialogBibleNatatka.getInstance(perevod = DialogVybranoeBibleList.PEREVODCARNIAUSKI, novyzavet = false, kniga = knigaReal, glava = BibleGlobalList.mListGlava, stix = BibleGlobalList.bibleCopyList[0], bibletext = knigaName)
    ...
    companion object {
        fun newInstance(title: String, page: Int, kniga: Int, pazicia: Int): StaryZapavietCarniauskiFragment {
            val fragmentFirst = StaryZapavietCarniauskiFragment()
            val args = Bundle()
