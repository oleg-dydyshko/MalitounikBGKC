...
class PsalterNadsana1(private val activity: Activity) : Fragment(), View.OnClickListener {

    private var _binding: NadsanPravila1Binding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = NadsanPravila1Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (dzenNoch) {
            ...
            binding.t2.setBackgroundResource(by.carkva_gazeta.malitounik.R.drawable.nadsanblack)
