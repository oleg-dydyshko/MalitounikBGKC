...
import by.carkva_gazeta.resources.databinding.NadsanPravila4Binding

class PsalterNadsana4(private val activity: Activity) : Fragment(), View.OnClickListener {

    private var _binding: NadsanPravila4Binding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = NadsanPravila4Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id ?: 0) {
            ...
            R.id.textView6 -> glava = 7
            R.id.textView7 -> glava = 8
            R.id.textView8 -> glava = 11
            R.id.textView9 -> glava = 12
            R.id.textView11, R.id.textView21 -> glava = 13
            R.id.textView12, R.id.textView25 -> glava = 16
            R.id.textView13, R.id.textView23 -> glava = 19
            R.id.textView15 -> glava = 3
            R.id.textView17 -> glava = 6
            R.id.textView18 -> glava = 9
            R.id.textView19 -> glava = 10
