...
class StaryZapavietSemuxa : BaseActivity(), DialogFontSizeListener, DialogBibleRazdelListener, BibleListiner, DialogBibleNatatka.DialogBibleNatatkaListiner, DialogAddZakladka.DialogAddZakladkiListiner {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TabLayoutMediator(binding.tabLayout, binding.pager, false) { tab, position ->
            tab.text = if (kniga == 18) getString(by.carkva_gazeta.malitounik.R.string.psalom) + " " + (position + 1)
            else getString(by.carkva_gazeta.malitounik.R.string.razdzel) + " " + (position + 1)
        }.attach()
